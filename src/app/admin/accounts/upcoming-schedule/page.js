  ...
  return (
    <div className="p-5">
      ...
      <div className="flex max-w-[55rem] focus-within:border-primary mx-auto border border-gray-300 items-center rounded-md ">
        <input
          className="px-4 py-2  text-gray-900 text-sm rounded-lg outline-none block w-full p-2.5 lg:py-3"
          type="text"
          placeholder="Search..."
          value={searchText}
      ...
      <div className="flex max-w-[55rem] mx-auto items-center mt-5">
        <div
          onClick={() =>
            router.push('/admin/accounts/upcoming-schedule/create-event')
          }
          className="bg-primary w-2/3 mx-auto flex items-center justify-center gap-3 py-1 rounded-full cursor-pointer lg:py-2"
        >
