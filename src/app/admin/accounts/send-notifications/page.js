        ...
        <div className="p-5 relative">
          ...
          {!clientSelected && (
            <div className="mx-auto">
              ...
              >
                <input
                  className="px-4 py-2  text-gray-900 text-sm rounded-lg outline-none block w-full p-2.5 xl:p-3"
                  type="text"
                  placeholder="Search..."
                />
          ...
          {clientSelected && (
            <div className="bg-[#FFDED7] max-w-[55rem] mx-auto px-5 py-2 rounded-lg mt-5">
                  ...
                  <form className="flex w-full flex-col items-center justify-center mt-10">
                    <div className="grid gap-3 md:grid-cols-2 w-full">
                      <div className="mb-3 w-full md:col-span-2">
                        <input
                          type="text"
                          className="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary outline-none block w-full p-2.5 xl:p-3"
