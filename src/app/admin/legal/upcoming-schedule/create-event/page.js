  ...
  const renderDateInput = () => {
    return formData.date ? (
      <input
        ...
        type="date"
        className="mt-1 block w-full bg-[#E6E6E6] xl:py-3 px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-md"
      />
    ) : (
      <input
        name="date"
        ...
        className="mt-1 bg-[#E6E6E6] block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm xl:py-3 focus:outline-none focus:ring-primary focus:border-primary sm:text-md"
      />
    )
  }
  ...
  const renderTimeInput = () => {
    return formData.time ? (
      <input
        ...
        onChange={handleInputChange}
        type="time"
        className="mt-1 xl:py-3 block w-full px-3 py-2 border bg-[#E6E6E6] border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-md"
      />
    ) : (
      <input
        name="time"
        ...
        className="mt-1 xl:py-3 bg-[#E6E6E6] block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-md"
      />
    )
  }
              ...
              <div className="max-w-[55rem] mx-auto mt-5">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="w-full">
                    <input
                      ...
                      className="mt-1 block w-full px-3 py-2 text-slate-700 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-md bg-[#FFDED7]"
                      disabled
                    />
                  </div>
                  <div className="w-full">
                  ...
                  <div className="w-full col-span-2">
                    <input
                      ...
                      className="mt-1 bg-[#E6E6E6] block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-md"
                    />
                  </div>
                ...
                <div className="flex justify-center mt-10">
                  <button
                    ...
                    className="bg-primary rounded-full xl:py-3 xl:px-32 py-2 px-10 text-white"
                  >
                    Create Event
                  </button>
                </div>
