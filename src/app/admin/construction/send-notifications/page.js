    ...
    <>
      {loading ? (
        ...
        <div className="p-5 relative">
          ...
          {clientSelected ||
            (allClient && (
              <div className="bg-[#FFDED7] max-w-[55rem] mx-auto px-5 py-2 rounded-lg mt-5 xl:py-3">
                  ...
                  <form className="flex w-full flex-col items-center justify-center mt-10">
                    ...
                    <div className="flex mt-3 justify-center w-full md:col-span-2">
                      <button
                        ...
                        className="px-10 w-72 py-2.5 rounded-3xl xl:py-3 bg-primary text-white text-sm font-medium"
                      >
                        Send
                      </button>
                    </div>
