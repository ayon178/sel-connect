...
import ClientFeedTableConst from '@/components/admin/construction/ClientFeedTableConst'
import Statistics from '@/components/admin/statistics/Statistics'
import CustomHeading from '@/components/shared/CustomHeading'
import Loader from '@/components/shared/Loader'
import {
  getConstructionFeedByStatus,
...
const aa = [
  'Requirement', // need to add this in edit feedback
  'Materials',
  'Admin Feedback',
  'Service Status',
  'Notes',
  ...
  return (
    <div className="p-5 custom_width pb-0">
      ...
      <div className="flex justify-center">
        {user?.sub === '0' && <Statistics data={statisticsData} />}
      </div>
      ...
      <div className="flex items-center justify-between w-full sm:w-1/2 mx-auto gap-4">
        ...
        <div className="w-1/2 mt-7">
          ...
          <input
            ...
            type="date"
            id="date"
            className="border border-primary rounded-[4px] w-full p-2 lg:py-2 py-1 outline-none"
          />
        </div>
      </div>
