  ...
  return (
    <div className="p-5">
      ...
      <div className="flex max-w-[55rem] mx-auto items-center mt-5">
        <div
          onClick={() =>
            router.push('/admin/construction/upcoming-schedule/create-event')
          }
          className="bg-primary w-2/3 mx-auto flex items-center justify-center gap-3 py-1 rounded-full cursor-pointer xl:py-2"
        >
