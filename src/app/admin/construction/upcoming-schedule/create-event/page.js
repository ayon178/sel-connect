  ...
  const renderDateInput = () => {
    return formData.date ? (
      <input
        ...
        type="date"
        className="mt-1 block w-full xl:py-3 bg-[#E6E6E6] px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-md"
      />
    ) : (
      <input
        name="date"
        ...
        className="mt-1 bg-[#E6E6E6] block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none xl:py-3 focus:ring-primary focus:border-primary sm:text-md"
      />
    )
  }
    ...
    <>
      {loading ? (
        ...
        <div className="p-5 relative">
          ...
          {(clientSelected || allClient) && (
            <div className="bg-[#FFDED7] max-w-[55rem] xl:py-3 mx-auto px-5 py-2 rounded-lg mt-5">
