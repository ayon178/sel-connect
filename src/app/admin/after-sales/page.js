...
const AfterSales = () => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl xl:text-4xl font-semibold text-slate-600 mb-2 text-center xl:px-10">
      ...
      <p className="w-full sm:w-1/2 text-center text-slate-600 font-medium mb-6 xl:mb-10 xl:text-lg">
        See the feedback from clients and improve the services
      </p>
      <button
        onClick={() => router.push('/admin/after-sales/client-feedback')}
