...
const FeedbackView = ({ params }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const data = await getFeedById('after_sales_feedback', feedid)
      setFeedData(data)
    ...
    <>
      <div className="p-5">
        ...
        {loading ? (
          ...
          <>
            <div className="shadow-lg py-5 px-10 max-w-[55rem] mx-auto rounded-lg border">
            ...
            <div className="shadow-lg py-5 px-10 max-w-[55rem] mx-auto rounded-lg border mt-8">
