...
const EditConstructionFeedPopup = ({ setOpenPopup, data, setRefetch }) => {
            ...
            <div className="grid grid-cols-2 gap-x-4">
              <div className="w-full">
                ...
                <input
                  ...
                  value={feedData.requirement}
                  type="text"
                  name="requirement"
                  placeholder="Requirement"
                  className="bg-gray-200 border border-transparent text-gray-900 text-sm rounded-lg outline-none focus:border-primary block  p-2.5 mt-1 w-full xl:py-3"
                />
              </div>
...
export default EditConstructionFeedPopup
