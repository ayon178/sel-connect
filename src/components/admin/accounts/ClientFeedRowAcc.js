...
import EditAccountsFeedPopup from '@/components/popup/editFeed/EditAccountsFeedPopup'

const ClientFeedRowAcc = ({ data: item, index, setRefetch }) => {
...
export default ClientFeedRowAcc
