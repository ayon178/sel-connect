...
import EditAfterSalesFeedPopup from '@/components/popup/editFeed/EditAfterSalesFeedPopup'

const ClientFeedRowAft = ({ data: item, index, setRefetch }) => {
...
export default ClientFeedRowAft
