...
import { AFTER_SALES_OPTIONS } from '@/utils/constant'
...
const GeneralFeed = ({ page, index }) => {
  ...
  const [formData, setFormData] = useState({
    title: AFTER_SALES_OPTIONS[index],
    description: '',
  })
  ...
  return (
    <div className="container mx-auto my-10 px-5 md:my-20">
      <div className="flex justify-between gap-10">
        <div className="w-[55rem]">
          <div className="flex justify-center text-center sm:text-start">
            <CustomHeading firstText="After Sales General Feedback" />
          </div>
